    ...
    <body class="animsition">
        ...
        <div class="site-hero_2">
            <div class="page-title">
                <div class="big-title montserrat-text uppercase">Services</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="section-title" style="text-align:left;float:left;width:100%;margin-bottom:0">
                            ...
                            <p class="montserrat-text uppercase">Créativité &amp; fiabilité</p>
                        </div>

                        <p>Nous sommes convaincu que la créativité est en chacun de nous. Grâce à des ateliers de design thinking ou des design sprint, nous relençons vos projets en partant du besoin de vos utilisateurs et en fiabilisant les fonctionnalités de vos produits.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title">
                        ...
                        <p>De la conception, jusqu'au design et au développement</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp">
                        ...
                        <span class="title montserrat-text uppercase">Atelier Design Thinking</span>
                        <p>Démarré, relancé ou améliorer un projet, rien de tel que le design thinking, ou les Google Design Sprint pour <strong>fiabiliser vos idées</strong>. Nous vous aidons à <span class="cheddar-text">libérer votre créativité</span> !</p>
                    </div>

                    <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".2s">
                        <i class="icon ion-compass"></i>
                        <span class="title montserrat-text uppercase">UX Design</span>
                        <p>Nous vous aidons à construire un site de qualité et qui réponds à tous les critères recherchés par vos utilisateurs. Des interfaces <i>fiables, adaptés et qui augmentent vos taux de conversion</i> tout en restant éthique.</p>
                    </div>

                    <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".1s">
                        <i class="icon ion-paintbrush"></i>
                        <span class="title montserrat-text uppercase">Web Design</span>
                        <p>Construire des interfaces adaptés et dans l'ère du temps peut vous permettre d'améliorer votre image de marque. Nous <strong>imaginons pour vous les interfaces</strong> qui séduirons vos clients et qui améliorerons votre relation avec eux.</p>
                    </div>

                    <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".4s">
                        <i class="icon ion-wand"></i>
                        <span class="title montserrat-text uppercase">Identité visuelle</span>
                        <p>Votre identité visuelle est la première chose que remarque vos nouveaux clients. Nous créons pour vous un <strong>univers graphique</strong> qui vous correspond et qui vous distingue afin de marquer vos clients dès leur première impression.</p>
                    </div>
